    ...
    public void validateOnDemandEntitlementForNewUser() {
        ...
        if (onDemandAssessmentPage.IsPortfolioTableLoaded()) {
            ...
            try {
                ...
                // assertTestCase.assertTrue(!onDemandAssessmentPage.validateNoPortfolio(), "Validating No porfolio text should not be displayed in portfolio list table");
                ...
                apiController.deletePortfolioByName(portfolioName);
            } catch (Exception e) {
                apiController.deletePortfolioByName(portfolioName);
                e.printStackTrace();
            }
