package com.esgc.Utilities.APIUtulities;

/**
 * This utility class created to store all Endpoints for API calls
 */

public class EntityIssuerPageEndPoints {

    public static String POST_SOURCE_DOCUMENTS = "api/issuer/source-documents";
    public static String POST_SUMMARY = "api/issuer/summary";
    public static String POST_HEADER = "api/issuer/header";
    public static String POST_CONTROVERSIES = "api/issuer/dual-materiality/controversies";
