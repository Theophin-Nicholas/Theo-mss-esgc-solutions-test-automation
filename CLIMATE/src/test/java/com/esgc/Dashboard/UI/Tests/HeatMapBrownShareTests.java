...
public class HeatMapBrownShareTests extends DashboardUITestBase {
    ...
    public void compareUIandDBHeatMapBrownShareData() {
        ...
        String month = DateTimeUtilities.getPreviousMonthNumeric();
        String year = DateTimeUtilities.getCurrentYear();
        List<Map<String, Object>> dbBrownShareHeatMapData = dashboardQueries.getPortfolioBrownShareInfo("00000000-0000-0000-0000-000000000000", year, month);
    ...
    public void compareUIandApiHeatMapBrownShareData() {
        ...
        String month = DateTimeUtilities.getPreviousMonthNumeric();
        String year = DateTimeUtilities.getCurrentYear();
        List<Map<String, String>> apiBrownShareHeatMapData = getPortfolioBrownShareData("00000000-0000-0000-0000-000000000000", year, month);
        List<Map<String, String>> uiBrownShareHeatMapData = dashboardPage.getBrownShareDataFromHeatMapDrawer();
