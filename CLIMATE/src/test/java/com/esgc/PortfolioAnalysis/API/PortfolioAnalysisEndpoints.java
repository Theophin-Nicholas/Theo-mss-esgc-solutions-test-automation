...
public class PortfolioAnalysisEndpoints {
    ...
    public static String GET_PORTFOLIO_ANALYSIS_EXCEL_EXPORT = "/api/portfolio/{portfolio_id}/excel-report?fileName=Carbon%20Footprint_8-Jun-2022_1654699096466.json";
