...
public class RegulatoryReportingQueries {
    ...
    public List<Map<String, Object>> getSFDRCompanyOutput(String portfolioId, String year) {
        ...
        if(year.toLowerCase().equals("latest"))
            query = "with p as (SELECT COMPANY_NAME , IDENTIFIER_TYPE, YEAR, VE_ID,FACTSET_ID,HIGH_IMPACT_CHK,SFDR_1TXNMYID_1,SFDR_1TXNMYID_2,SFDR_1TXNMYID_4,RPTNG_YR_FOR_SFDR_1,SFDR_2TXNMYID_27,\n" +
                    ...
                    "AND DATE_BASED_DATA_TYPE='yearly'),\n" +
                    "q as (select * from p where SFDR_1TXNMYID_1<>'NULL' qualify row_number() OVER (partition BY FACTSET_ID ORDER BY FACTSET_ID, YEAR DESC) =1)\n" +
