...
public class EUTaxonomyTests extends UITestBase {
    ...
    public void verifyEUTaxonomyPageTest() {
        ...
        euTaxonomyPage.navigateToPageFromMenu("Regulatory Reporting");
    ...
    public void verifyValuesAreRemainingForEUTaxonomy() {
        ...
        double random1 = PortfolioUtilities.randomBetween(100, 1000) / 10d;
        double random2 = PortfolioUtilities.randomBetween(100, 1000) / 10d;
        ...
        euTaxonomyPage.navigateToPageFromMenu("Regulatory Reporting");
        test.info("User goes back to EU taxonomy");
